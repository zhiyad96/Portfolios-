...
//       description: "Live analytics dashboard with WebSocket connections",
//       tech: ["Python", "FastAPI", "Socket.io", "Chart.js"],
//       link: "#",
...
//               <div
//                 key={index}
//                 className="bg-gradient-to-r from-white to-gray-600 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2"
//               >
...
//                   <p className="text-gray-800 text-sm sm:text-base mb-4 md:mb-6">{project.description}</p>
//                   <div className="flex flex-wrap gap-1 sm:gap-2 mb-4 md:mb-6">
//                     {project.tech.map((tech) => (
//                       <span key={tech} className="px-2 sm:px-3 py-1 bg-gradient-to-r from-white to-gray-600 text-black rounded-full text-xs sm:text-sm">
//                         {tech}
//                       </span>
//                     ))}
//                   </div>
...
//               <div
//                 key={index}
//                 className="text-center p-4 sm:p-6 rounded-2xl bg-gradient-to-r from-white to-gray-600 hover:bg-white hover:shadow-xl transition-all duration-300"
//               >
...
//             </p>
//             <div className="bg-gradient-to-r from-gray-600 to-gray-500 rounded-2xl p-4 sm:p-6 md:p-8 shadow-xl">
//               <div className="space-y-4 sm:space-y-6">
//                 <div className="text-left">
//                   <label className="block text-black mb-2 font-medium text-sm sm:text-base">Email</label>

//                   <form className="bg-gradient-to-r from-gray-600 to-gray-500 rounded-2xl p-4 sm:p-6 md:p-8 shadow-xl"
...
//                     <a href="https://github.com/zhiyad96" className="flex-1 p-3 sm:p-4 bg-gray-900 text-white rounded-xl hover:bg-black transition-all duration-300 flex items-center justify-center gap-2 text-sm sm:text-base">
//                       <FaGithub /> GitHub
//                     </a>
//                     <a href="#" className="flex-1 p-3 sm:p-4 bg-gray-600 text-white rounded-xl hover:bg-gray-500 transition-all duration-300 flex items-center justify-center gap-2 text-sm sm:text-base">
//                       <FaLinkedin /> LinkedIn
//                     </a>
//                   </div>
//                 </div>
